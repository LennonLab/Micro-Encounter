...
#plt.text(300, -1.2, 'Simple', fontsize=fs+6)
...
#plt.text(100, -1.2, 'Run and tumble', fontsize=fs+6)
...
#plt.text(500, -1.2, 'Passive', fontsize=fs+6)


#### Final Format and Save #####################################################
plt.subplots_adjust(wspace=0.4, hspace=0.4)
plt.savefig(mydir + '/results/figures/TimeSeries-ResourceEffectsOnEncounters-Trophic.png', dpi=600, bbox_inches = "tight")
plt.close()
