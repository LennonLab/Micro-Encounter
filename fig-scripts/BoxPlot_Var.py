...
dat['Encounter'] = np.log10(dat['VarEncounter'])
...
ax.boxplot(data_to_plot, showmeans=True)
...
plt.savefig(mydir + '/results/figures/BoxPlot_Var.png', dpi=600, bbox_inches = "tight")
#plt.show()
